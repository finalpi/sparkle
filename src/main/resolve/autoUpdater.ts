...
export async function checkUpdate(): Promise<AppVersion | undefined> {
  ...
  let url = 'https://github.com/finalpi/sparkle/releases/latest/download/latest.yml'
  if (updateChannel == 'beta') {
    url = 'https://github.com/finalpi/sparkle/releases/download/pre-release/latest.yml'
  }
...
export async function downloadAndInstallUpdate(version: string): Promise<void> {
  ...
  const baseUrl = `https://github.com/finalpi/sparkle/releases/download/${releaseTag}/`
  const fileMap = {
  ...
  const apiUrl = `https://api.github.com/repos/finalpi/sparkle/releases/tags/${releaseTag}`
