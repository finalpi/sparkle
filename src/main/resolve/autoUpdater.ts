...
const UPDATE_MANIFEST_URLS: Record<AppUpdateChannel, string> = {
  stable: 'https://github.com/finalpi/sparkle/releases/latest/download/latest.yml',
  rolling: 'https://github.com/finalpi/sparkle/releases/download/rolling/latest.yml'
}
